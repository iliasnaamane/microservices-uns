 ...
 * 2017-11-06T04:58:40.468+01:00
 * Generated source version: 3.1.10
 * 
 */
@WebServiceClient(name = "ExternalHotelFinderService", 
                  wsdlLocation = "file:/home/neko/Integration/branch/microservices-uns/integration/flows/src/main/resources/hotel.wsdl",
...
public class ExternalHotelFinderService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/neko/Integration/branch/microservices-uns/integration/flows/src/main/resources/hotel.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ExternalHotelFinderService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/neko/Integration/branch/microservices-uns/integration/flows/src/main/resources/hotel.wsdl");
        }
        WSDL_LOCATION = url;
    }
