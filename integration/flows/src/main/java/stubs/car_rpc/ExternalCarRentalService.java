 ...
 * 2017-11-06T17:25:23.904+01:00
 * Generated source version: 3.1.10
 * 
 */
@WebServiceClient(name = "ExternalCarRentalService", 
                  wsdlLocation = "file:/home/neko/Integration/ilias/microservices-uns/integration/flows/src/main/resources/car.wsdl",
...
public class ExternalCarRentalService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/neko/Integration/ilias/microservices-uns/integration/flows/src/main/resources/car.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ExternalCarRentalService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/neko/Integration/ilias/microservices-uns/integration/flows/src/main/resources/car.wsdl");
        }
        WSDL_LOCATION = url;
    }
