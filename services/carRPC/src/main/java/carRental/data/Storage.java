...
public class Storage {
    ...
    static {
        ...
        Storage.createCar(5,"Londre",30.5F,"Seat","Ibiza");
        ...
        try {
            ...
            Storage.createRent(3, 2, new SimpleDateFormat("YYYY-MM-DD").parse("2017-08-23"), new SimpleDateFormat("YYYY-MM-DD").parse("2017-08-24"));
