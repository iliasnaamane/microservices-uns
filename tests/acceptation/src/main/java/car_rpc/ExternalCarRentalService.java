 ...
 * 2017-10-07T11:05:40.974+02:00
 * Generated source version: 3.1.10
 * 
 */
@WebServiceClient(name = "ExternalCarRentalService", 
                  wsdlLocation = "file:/home/neko/Integration/copytest/tests/acceptation/src/main/resources/CAR.wsdl",
...
public class ExternalCarRentalService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/neko/Integration/copytest/tests/acceptation/src/main/resources/CAR.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ExternalCarRentalService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/neko/Integration/copytest/tests/acceptation/src/main/resources/CAR.wsdl");
        }
        WSDL_LOCATION = url;
    }
