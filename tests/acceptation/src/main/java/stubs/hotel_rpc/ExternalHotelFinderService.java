 ...
 * 2017-10-22T06:18:01.457+02:00
 * Generated source version: 3.1.10
 * 
 */
@WebServiceClient(name = "ExternalHotelFinderService", 
                  wsdlLocation = "file:/Users/iliasnaamane/microservices-uns/tests/acceptation/src/main/resources/HOTEL.wsdl",
...
public class ExternalHotelFinderService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/iliasnaamane/microservices-uns/tests/acceptation/src/main/resources/HOTEL.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ExternalHotelFinderService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/iliasnaamane/microservices-uns/tests/acceptation/src/main/resources/HOTEL.wsdl");
        }
        WSDL_LOCATION = url;
    }
