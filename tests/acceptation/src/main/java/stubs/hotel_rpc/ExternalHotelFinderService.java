 ...
 * 2017-10-20T20:47:31.360+02:00
 * Generated source version: 3.1.10
 * 
 */
@WebServiceClient(name = "ExternalHotelFinderService", 
                  wsdlLocation = "file:/home/neko/Integration/bob/microservices-uns/tests/acceptation/src/main/resources/HOTEL.wsdl",
...
public class ExternalHotelFinderService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/neko/Integration/bob/microservices-uns/tests/acceptation/src/main/resources/HOTEL.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ExternalHotelFinderService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/neko/Integration/bob/microservices-uns/tests/acceptation/src/main/resources/HOTEL.wsdl");
        }
        WSDL_LOCATION = url;
    }
