 ...
 * 2017-10-20T20:47:31.895+02:00
 * Generated source version: 3.1.10
 * 
 */
@WebServiceClient(name = "ExternalCarRentalService", 
                  wsdlLocation = "file:/home/neko/Integration/bob/microservices-uns/tests/acceptation/src/main/resources/CAR.wsdl",
...
public class ExternalCarRentalService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/neko/Integration/bob/microservices-uns/tests/acceptation/src/main/resources/CAR.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ExternalCarRentalService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/neko/Integration/bob/microservices-uns/tests/acceptation/src/main/resources/CAR.wsdl");
        }
        WSDL_LOCATION = url;
    }
