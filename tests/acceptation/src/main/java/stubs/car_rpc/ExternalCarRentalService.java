 ...
 * 2017-11-11T15:38:03.203+01:00
 * Generated source version: 3.1.10
 * 
 */
@WebServiceClient(name = "ExternalCarRentalService", 
                  wsdlLocation = "file:/Users/iliasnaamane/microservices-uns/tests/acceptation/src/main/resources/CAR.wsdl",
...
public class ExternalCarRentalService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/iliasnaamane/microservices-uns/tests/acceptation/src/main/resources/CAR.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ExternalCarRentalService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/iliasnaamane/microservices-uns/tests/acceptation/src/main/resources/CAR.wsdl");
        }
        WSDL_LOCATION = url;
    }
