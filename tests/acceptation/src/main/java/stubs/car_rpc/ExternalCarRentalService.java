 ...
 * 2017-10-08T18:49:11.738+02:00
 * Generated source version: 3.1.10
 * 
 */
@WebServiceClient(name = "ExternalCarRentalService", 
                  wsdlLocation = "file:/Users/iliasnaamane/Downloads/copytest/tests/acceptation/src/main/resources/CAR.wsdl",
...
public class ExternalCarRentalService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/iliasnaamane/Downloads/copytest/tests/acceptation/src/main/resources/CAR.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(ExternalCarRentalService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/iliasnaamane/Downloads/copytest/tests/acceptation/src/main/resources/CAR.wsdl");
        }
        WSDL_LOCATION = url;
    }
